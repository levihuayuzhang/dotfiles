...

{
  imports =
    [ # Include the results of the hardware scan.
      ./levi-pc-hardware-configuration.nix
    ];
  ...
  services.syncthing = {
    ...
    user = "zhy";
    group = "users";
    configDir = "/home/zhy/.config/syncthing";
  ...
  systemd.services.mihomo = {
    ...
    serviceConfig = {
      ...
      ExecStart = "/home/zhy/bin/mihomo-linux-amd64 -d /home/zhy/proxy";
